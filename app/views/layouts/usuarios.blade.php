            ...
            <div class="panel-body">
                <div  class="table-responsive ">
                    <table id="tabla-registros" class="table mb30">
                        ...
                        <tbody>
                        <?php $contador = 0; ?>
                        @foreach (Usuarios::all() as $registro)
                        <tr>
                            <td>{{ ++$contador }}</td>
            ...
            <div class="modal-content  panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Correo<span class="asterisk">*</span></label>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Eliminar Usuario</h4>
            </div>
            <div class="panel-body">
                <div class="row">
            ...
            $.ajax(
            {
                ...
                success:function( data )
                {
                    if(data.resultado)
                    {
                        ...
                        $("#modal-editar-registro #form-editar #correo").val(data.registros.correo);
                        $("#modal-editar-registro #form-editar #usuario").val(data.registros.usuario);
