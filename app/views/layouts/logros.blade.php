<div class="pageheader">
    <h2><i class="fa fa-table"></i> Logros</h2> 
    </div>
            ...
            <div class="panel-body">
                <div  class="table-responsive ">
                    <table id="tabla-registros" class="table mb30">
                        ...
                        <tbody>
                        <?php $contador = 0; ?>
                        @foreach (Logros::with('candidato')->get() as $registro)
                        <tr>
                            <td>{{ ++$contador }}</td>
        ...
        <form id="form-crear" role="form"   method="post" >
            <div class="modal-content  panel panel-primary">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Crear Logro</h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <!-- Inputs -->
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Inicio<span class="asterisk">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Fin<span class="asterisk">*</span></label>
        ...
        <form id="form-editar" role="form"   method="post" >
            <div class="modal-content panel panel-info">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Editar Logro</h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <!-- Inputs -->
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label"> Candidato <span class="asterisk">*</span></label>
                                {{Form::select('idcandidato',array('0'=>'Elija un Candidato') + Candidatos::all()->lists('nombres','id'), null, array('id'=>'idcandidato', 'class'=>'form-control chosen-select input-lg'))}}
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Eliminar Logro</h4>
            </div>
            <div class="panel-body">
                <div class="row">
