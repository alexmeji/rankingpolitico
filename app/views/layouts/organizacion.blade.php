<div class="pageheader">
    <h2><i class="fa fa-table"></i> Organizacíones</h2> 
    </div>
            ...
            <div class="panel-body">
                <div  class="table-responsive ">
                    <table id="tabla-registros" class="table mb30">
                        ...
                        <tbody>
                        <?php $contador = 0; ?>
                        @foreach (Organizacion::with('tipoorganizacion')->get() as $registro)
                        <tr>
                            <td>{{ ++$contador }}</td>
                            <td>{{ $registro->nombre }}</td>
                            <td>{{ $registro->descripcion }}</td>
                            <td>{{ $registro->tipoorganizacion->nombre }}</td>
                            <td>{{ $registro->fechafundacion }}</td>
                            <td >
        ...
        <form id="form-crear" role="form"   method="post" enctype="multipart/form-data" accept-charset="utf-8">
            <div class="modal-content  panel panel-primary">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Crear Organizacion</h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <!-- Inputs -->
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Fecha Fundacion<span class="asterisk">*</span></label>
                                <input type="text" name="fechafundacion" class="form-control" required/>
                            </div>
                        </div>

                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label"> Tipo Organización <span class="asterisk">*</span></label>
                                {{Form::select('idtipoorganizacion',array('0'=>'Elija un tipo de organizacion') + TipoOrganizacion::all()->lists('nombre','id'), null, array('id'=>'idtipoorganizacion', 'class'=>'form-control chosen-select input-lg'))}}
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <form id="form-editar" role="form"   method="post" enctype="multipart/form-data" accept-charset="utf-8">
            <div class="modal-content panel panel-info">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Editar Organización</h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <!-- Inputs -->
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Fecha Funcacion<span class="asterisk">*</span></label>
                                <input type="text" id="fechafundacion" name="fechafundacion" class="form-control" required/>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    {    
        ...
        function mostrarModalEditar( e )
        {
            ...
            {
                type: "GET",
                url: "/ws/organizacion/"+idregistro,
                dataType: "json",
                data: {},
                success:function( data )
                {
                    if(data.resultado)
                    {
                        ...
                        $("#modal-editar-registro #form-editar #fechafundacion").val(data.registros.fechafundacion);
                        $("#modal-editar-registro #form-editar #idtipoorganizacion").val(data.registros.idtipoorganizacion);
                        $("#modal-editar-registro #form-editar #idtipoorganizacion").trigger("chosen:updated");
