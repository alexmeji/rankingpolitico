<div class="pageheader">
    <h2><i class="fa fa-table"></i> Criterios</h2> 
    </div>
            ...
            <div class="panel-body">
                <div  class="table-responsive ">
                    <table id="tabla-registros" class="table mb30">
                        ...
                        <tbody>
                        <?php $contador = 0; ?>
                        @foreach (Criterios::all() as $registro)
                        <tr>
                            <td>{{ ++$contador }}</td>
        ...
        <form id="form-crear" role="form"   method="post" >
            <div class="modal-content  panel panel-primary">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Crear Criterio</h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <!-- Inputs -->
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Puntuación<span class="asterisk">*</span></label>
                                <input type="text" name="puntuacion" class="form-control" required/>
                            </div>
                        </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Puntuación<span class="asterisk">*</span></label>
                                <input type="text" id="puntuacion" name="puntuacion" class="form-control" required/>
                            </div>
                        </div>
                        <!-- /Inputs -->
                    </div>
            ...
            $.ajax(
            {
                ...
                success:function( data )
                {
                    if(data.resultado)
                    {
                        ...
                        $("#modal-editar-registro #form-editar #puntuacion").val(data.registros.puntuacion);
