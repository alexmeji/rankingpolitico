<div class="pageheader">
    <h2><i class="fa fa-table"></i> Preguntas</h2> 
    </div>
            ...
            <div class="panel-body">
                <div  class="table-responsive ">
                    <table id="tabla-registros" class="table mb30">
                        ...
                        <tbody>
                        <?php $contador = 0; ?>
                        @foreach (Preguntas::all() as $registro)
                        <tr>
                            <td>{{ ++$contador }}</td>
...
{{-- Modal de crear registro asdfasdfsadfasd --}}
        ...
        <form id="form-crear" role="form"   method="post" >
            <div class="modal-content  panel panel-primary">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Crear Pregunta</h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <!-- Inputs -->
        ...
        <form id="form-editar" role="form"   method="post" >
            <div class="modal-content panel panel-info">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Editar Pregunta</h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <!-- Inputs -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Eliminar Pregunta</h4>
            </div>
            <div class="panel-body">
                <div class="row">
