...
class PuestosController extends \BaseController {
	...
	{
		//
		$respuesta["registros"] = Puestos::with("candidatura")->get()->toArray();
	...
	{
		//
		if( Input::get("titulo") && Input::get("descripcion")  && Input::get("idcandidatura"))
		{
			try
			{
				$registro = new Puestos();
				$registro->titulo = Input::get("titulo");
				$registro->descripcion = Input::get("descripcion");
				$registro->idcandidatura = Input::get("idcandidatura");
	...
	public function update($id)
	{
		...
		if( $registro )
		{
			...
			$registro->idcandidatura = Input::get("idcandidatura", $registro->idcandidatura);
