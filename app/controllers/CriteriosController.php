...
class CriteriosController extends \BaseController {
	...
	{
		//
		$respuesta["registros"] = Criterios::all()->toArray();
	...
	{
		//
		if( Input::get("titulo") && Input::get("puntuacion") )
		{
			
				$registro = new Criterios();
				$registro->titulo = Input::get("titulo");
				$registro->descripcion = Input::get("descripcion");
				$registro->puntuacion = Input::get("puntuacion");
	...
	public function update($id)
	{
		...
		if( $registro )
		{
			...
			$registro->puntuacion = Input::get("puntuacion", $registro->puntuacion);
